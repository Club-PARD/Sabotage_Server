...
public class ListEjectionRankResponse {
    ...
    public static ListEjectionRankResponse of(Long userId, List<EjectionRankResponse> ejectionRanks, EjectionRankResponse myEjectionRank){ return new ListEjectionRankResponse(userId, ejectionRanks, myEjectionRank); }
}
